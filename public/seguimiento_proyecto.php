...
<?php if ($proyectoId > 0): ?>
  ...
  <div class="card p-4 mb-4">
    ...
    <div class="form-hint">Conversión a CLP usa la fecha contable y, si no existe, la fecha de entrega.</div>
    <?php if (!empty($sinTc) && $sinTc > 0): ?>
      <div class="form-hint text-danger">Hay <?= (int)$sinTc ?> orden(es) sin tipo de cambio registrado en su fecha contable o fecha de entrega.</div>
    <?php endif; ?>
  </div>
